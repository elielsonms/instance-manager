#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# Base undeploy script template — Schema v1
# ---------------------------------------------------------------------------
# Copy this file to instances/<your-instance>/scripts/undeploy.sh and
# implement the undeployment logic for your specific instance.
#
# This script is called by the "Undeploy Release from Instance" workflow with
# the following environment variables already set:
#
...
echo "[INFO] Undeploying release ${RELEASE_VERSION} from instance ${INSTANCE}"

# TODO: Implement instance-specific undeployment logic here.

echo "[INFO] Undeploy completed"
